      ...
      <main className="flex-1 max-w-5xl mx-auto w-full p-6">
        <div className="grid gap-6">
          <div className="bg-card border rounded-lg p-6">
            <h2 className="text-xl font-semibold mb-4">Ana Panel</h2>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <Link href="/iskonto-listesi" className="block">
                <div className="bg-secondary/10 p-4 rounded-md border border-secondary/20 hover:bg-secondary/20 transition-colors">
              ...
              {isAdmin && (
                <Link href="/admin" className="block">
                  <div className="bg-primary/10 p-4 rounded-md border border-primary/20 hover:bg-primary/20 transition-colors">
